...
if(isset($_POST['login']))
{
    ...
    $sql_check = $link->query("select * from nguoidung where username = '$username'");
    ...
    {
        $sql_check2 = $link->query("select * from nguoidung where username = '$username' and password = '$password'");
