...
<form action="update_dangky.php" method="post" name="frm" onsubmit="return dangky()">
	<div class="dangky">
		...
		<table>
		<tr>
			<td>Tên đăng nhập  <font color="red">*</font> </td><td class="input"> <input style="width: 80%;
  height: 30px;
  padding: 12px 20px;
  ...
  font-size: 16px;
  resize: none;" type="text" name="user" size="40"></td>
		</tr>
		<tr>
			<td>Tên người dùng <font color="red">*</font> </td><td class="input"><input style="width: 80%;
  height: 30px;
  padding: 12px 20px;
  box-sizing: border-box;
  border: 2px solid #ccc;
  ...
  background-color: #f8f8f8;
  font-size: 16px;
  resize: none;" type="text" name="tennd" size="40"></td>
		</tr>
		<tr>
			<td>Mật khẩu <font color="red">*</font> </td><td class="input"><input style="width: 80%;
  height: 30px;
  padding: 12px 20px;
  box-sizing: border-box;
  border: 2px solid #ccc;
  ...
  background-color: #f8f8f8;
  font-size: 16px;
  resize: none;" type="password" name="pass" size="40" ></td>
		</tr>
		<tr>
			<td>Nhập lại mật khẩu <font color="red">*</font> </td><td class="input"><input style="width: 80%;
  height: 30px;
  padding: 12px 20px;
  box-sizing: border-box;
  border: 2px solid #ccc;
  ...
  background-color: #f8f8f8;
  font-size: 16px;
  resize: none;" type="password" name="pass1" size="40"></td>
		</tr>
		<tr>
			<td>Ngày sinh </td><td class="input"><input style="width: 80%;
  height: 30px;
  padding: 12px 20px;
  box-sizing: border-box;
  border: 2px solid #ccc;
  ...
  background-color: #f8f8f8;
  font-size: 16px;
  resize: none;" type="date" name="ngaysinh"></td>
		</tr>
		<tr>
		...
		<tr>
			<td>Email <font color="red">*</font> </td><td class="input"><input style="width: 80%;
  height: 30px;
  padding: 12px 20px;
  box-sizing: border-box;
  border: 2px solid #ccc;
  ...
  resize: none;" type="text" name="email" size="40"></td>
		...
		<tr>
			<td>Điện thoại <font color="red">*</font> </td><td class="input"><input style="width: 80%;
  height: 30px;
  padding: 12px 20px;
  box-sizing: border-box;
  border: 2px solid #ccc;
